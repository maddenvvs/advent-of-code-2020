from aoc2020.solutions.day_04 import count_passwords_with_weak_validation, count_passwords_with_strong_validation


def test_weak_validation() -> None:
...
def test_strong_validation_1() -> None:
...
def test_strong_validation_2() -> None:
